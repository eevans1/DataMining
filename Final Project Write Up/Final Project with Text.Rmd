...
###IV. Results  
We found that it is very possible to build high-performing teams with a much lower salary than many of the top teams. Using the random forest, we found the following:
